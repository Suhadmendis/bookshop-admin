...
<head>
    ...
    <title>Search Delivery Rate</title>
    ...
    <script language="JavaScript" src="js/m_delivery_rate.js"></script>
...
<div id="filt_table" class="CSSTableGenerator container">
    <table id='example'  class='table table-bordered'>
        ...
        <tbody>
        <?php
        $sql = "SELECT * from m_delivery_rate";
        ...
        foreach ($conn->query($sql) as $row) {
            ...
            echo "<tr>                
                              ...
                              <td onclick=\"getForm('$REF','$IDF');\">" . $row['delivery_charge'] . "</a></td>
                              </tr>";
        }
        ?>
    </table>
