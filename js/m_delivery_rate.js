var vue = new Vue({
    ...
    mounted() {
        axios.get("m_delivery_rate_date.php?Command=generate").then((response) => {
...
function save_info() {
    ...
    var url = "m_delivery_rate_date.php";
    url = url + "?Command=" + "save_item";
    url = url + "&REF=" + document.getElementById("REF").value;
    url = url + "&city=" + document.getElementById("city").value;
    url = url + "&delivery_charge=" + document.getElementById("delivery_charge").value;
...
function cancel_imb() {
    ...
    var url = "m_delivery_rate_data.php";
...
function getFromValues() {
    ...
    if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete") {
        ...
        if (IDF === "Master") {
            ...
            opener.document.getElementById("delivery_charge").value = objSup.delivery_charge;
        }
        if (IDF === "item") {
            opener.document.getElementById("delivery_ref").value = objSup.REF;
            opener.document.getElementById("delivery_name").value = objSup.city;
        }
