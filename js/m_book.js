var vue = new Vue({
  ...
  data: {
    ...
    mounted () {
        axios
          .get('m_book_data.php?Command=generate')
          .then(response => {
          ...
          for (i = 0; i < rowCount; i++) {
            ...
            //   }
              ...
              if (IDF === "Syll_add_book") {
                ...
                for (i = 0; i < rowCount; i++) {
                  if (
                    window.opener.document.getElementById("exampletable").rows[
                      i
...
$("#img_file").on("change", function () {
  ...
  $.ajax({
    url: "m_book_data.php?Command=upload",
    dataType: "script",
    cache: false,
    contentType: false,
    processData: false,
