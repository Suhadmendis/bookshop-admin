var vue = new Vue({
    ...
    mounted() {
        axios.get("m_inquiry_data.php?Command=generate").then((response) => {
...
function save_info() {
    ...
    url = url + "&inquiry=" + document.getElementById("inquiry").value;
...
function getFromValues() {
    ...
    if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete") {
        ...
        if (IDF === "Master") {
            ...
            opener.document.getElementById("inquiry").value = objSup.inquiry;
            opener.document.getElementById("status").value = objSup.status;
        }
        if (IDF === "item") {
            opener.document.getElementById("inquiry_ref").value = objSup.REF;
            opener.document.getElementById("inquiry_name").value = objSup.name;
        }
