var vue = new Vue({
    ...
    mounted() {
        axios.get("m_complaint_data.php?Command=generate").then((response) => {
...
function save_info() {
    ...
    url = url + "&order_ref=" + document.getElementById("order_ref").value;
    url = url + "&issue_ref=" + document.getElementById("issue_ref").value;
    url = url + "&issue_name=" + document.getElementById("issue_name").value;
    url = url + "&name=" + document.getElementById("name").value;
    url = url + "&tel=" + document.getElementById("tel").value;
    url = url + "&email=" + document.getElementById("email").value;
    url = url + "&issue=" + document.getElementById("issue").value;
...
function getFromValues() {
    ...
    if (xmlHttp.readyState == 4 || xmlHttp.readyState == "complete") {
        ...
        if (IDF === "Master") {
            ...
            opener.document.getElementById("order_ref").value = objSup.order_ref;
            opener.document.getElementById("issue_ref").value = objSup.issue_ref;
            opener.document.getElementById("issue_name").value = objSup.issue_name;
            opener.document.getElementById("name").value = objSup.name;
            opener.document.getElementById("tel").value = objSup.tel;
            opener.document.getElementById("email").value = objSup.email;
            opener.document.getElementById("issue").value = objSup.issue;
        }
        if (IDF === "item") {
            opener.document.getElementById("complaint_ref").value = objSup.REF;
            opener.document.getElementById("complaint_name").value = objSup.name;
        }
