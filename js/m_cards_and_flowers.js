var vue = new Vue({
  ...
  mounted() {
    axios
      .get("m_cards_and_flowers_data.php?Command=generate")
      .then((response) => {
...
//     var url = "m_cards_and_flowers_data.php";
...
$("#img_file").on("change", function () {
  ...
  $.ajax({
    url: "m_cards_and_flowers_data.php?Command=upload",
    dataType: "script",
    cache: false,
    contentType: false,
    processData: false,
    ...
    success: function (res) {
      ...
      document.getElementById("img_path").innerHTML =
        '<img src="uploads/item/card/' + res + '" alt="" width="400" >';
