...
<head>
    ...
    <script language="JavaScript" src="js/m_complaint.js"></script>
    ...
    <table id='example'  class='table table-bordered'>
        ...
        foreach ($conn->query($sql) as $row) {
            ...
            echo "<tr>                
                              ...
                              <td onclick=\"getForm('$REF','$IDF');\">" . $row['order_ref'] . "</a></td>
                              <td onclick=\"getForm('$REF','$IDF');\">" . $row['issue_ref'] . "</a></td>
                              <td onclick=\"getForm('$REF','$IDF');\">" . $row['issue_name'] . "</a></td>
                              <td onclick=\"getForm('$REF','$IDF');\">" . $row['name'] . "</a></td>
                              <td onclick=\"getForm('$REF','$IDF');\">" . $row['tel'] . "</a></td>
                              <td onclick=\"getForm('$REF','$IDF');\">" . $row['email'] . "</a></td>
                              <td onclick=\"getForm('$REF','$IDF');\">" . $row['issue'] . "</a></td>
                              </tr>";
        }
        ?>
    </table>
