        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <div class="btn-group" style="padding: 10px;">
                    ...
                    <a class="btn btn-primary" onclick="window.open('search_m_inquiry.php?IDF=Master', 'mywin', 'width=800, height=700');" class="btn btn-info btn-sm">Search</a>
                ...
                <form role="form">
                    <div class="box-body col-md-12">
                        ...
                        <div class="form-group">
                            <div class="col-sm-2">
                                <label for="first_name" >Inquiry</label>
                            </div>
                            <div class="col-sm-3">
                                <input type="text" class="form-control" id="inquiry" placeholder="Inquiry">
                            </div>
                        </div><br><br>
...
<script src="js/m_inquiry.js"></script>
<!-- <script>getdt();</script> -->
