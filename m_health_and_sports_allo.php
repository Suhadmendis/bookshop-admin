        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">{{ en_name }}Health and Sports Allocation</h3>
            </div>
            <!-- /.box-header -->
             <div class="btn-group" style="padding: 10px;">
              <a class="btn btn-success" onclick="save_info();">Save</a>
              <a class="btn btn-primary" onclick="window.open('search_m_store.php?IDF=health_allo', 'mywin', 'width=1200, height=700');" class="btn btn-info btn-sm">Search Store</a>
            ...
            <form role="form">
              <div class="box-body col-md-12">
               ...
               <div class="col-md-2">
                    <a class="btn btn-default" onclick="window.open('search_m_health_and_sports.php?IDF=ADD_HEALTH', 'mywin', 'width=800, height=700');" class="btn btn-info btn-sm">Add Health and Sports</a>
                  </div>
                </div><br><br>
...
<script src="js/m_health_and_sports_allo.js"></script>
