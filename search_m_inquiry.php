...
<head>
    ...
    <script language="JavaScript" src="js/m_inquiry.js"></script>
    ...
    <table id='example'  class='table table-bordered'>
        ...
        foreach ($conn->query($sql) as $row) {
            ...
            echo "<tr>                
                              ...
                              <td onclick=\"getForm('$REF','$IDF');\">" . $row['inquiry'] . "</a></td>
                              <td onclick=\"getForm('$REF','$IDF');\">" . $row['status'] . "</a></td>
                              </tr>";
        }
        ?>
    </table>
